...
class Player(Ship):
    '''class method for player ship inherited from parent class ship'''
    def __init__(self, x, y, health=100):
...
class Enemy(Ship):
    '''class method for enemy ship inherited from parent class ship'''
    COLOR_MAP = {
