...
class Paddle:
    ...
    """A class method to initialise and movement paddle"""
    
    COLOR = BLACK
    VEL = 4

    def __init__(self, x, y, width, height):
        '''initialising width, height and position of paddle'''
    ...
    def move(self, up=True):
        '''movment of paddle on game window'''
        if up:
            self.y -= self.VEL
        else:
            self.y += self.VEL
...
class Ball:
    ...
    """A class method to initialise and movement of ball"""
    
    MAX_VEL = 5
    COLOR = BLACK

    def __init__(self, x, y, radius):
        '''initialising radius and position of ball'''
        self.x = self.original_x = x
        self.y = self.original_y = y
        self.radius = radius
